...
exports.selectOneUser = (req, res) => {
    ...
    mysqlConnection.query("SELECT * FROM Users WHERE id_users = ?", [id_users], (err, rows, fields) => {
        if (!err) {
            res.send(rows);
        } else {
            console.log(err);
...
exports.registerUsers = async (req, res) => {
    ...
    try {
        ...
        mysqlConnection.query(sql, [users.pseudo, users.email, hash], (err, rows, fields) => {
            if (!err) {
                res.send(rows);
            } else {
                console.log(err);
...
exports.updateUsers = (req, res) => {
    ...
    mysqlConnection.query(sql, [users.pseudo, users.email, users.pass, users.id_users], (err, rows, fields) => {
        if (!err) {
...
exports.deleteUsers = (req, res) => {
    let id_users = req.params.id_users;
    mysqlConnection.query("DELETE FROM Users WHERE id_users = ?", [id_users], (err, rows, fields) => {
        if (!err) {
