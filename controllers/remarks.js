...
exports.selectOneRemark = (req, res) => {
    ...
    mysqlConnection.query("SELECT * FROM Remarks WHERE id_remarks = ?", [id_remarks], (err, rows, fields) => {
        if (!err) {
            res.send(rows);
        } else {
            console.log(err);
...
exports.modifyOneRemark = (req, res) => {
    ...
    console.log(`id_users: ${id_users} id_posts: ${id_posts} id_remarks: ${id_remarks}`);
    console.log(req.body);
};
...
exports.deleteOneRemark = (req, res) => {
    ...
    let id_posts = req.params.id_posts;
    let id_remarks = req.params.id_remarks;
    mysqlConnection.query("DELETE FROM Remarks WHERE id_remarks = ?", [id_remarks], (err, rows, fields) => {
        if (!err) {
